...
<body>
    <nav class="bg-gray-800 p-4">
        <ul class="flex items-center space-x-4 text-white">
            <!-- Navigation links -->
            <li>
                <a href="{{ url('/') }}" class="{{ Request::is('/') ? 'font-bold underline' : '' }} hover:text-gray-300">
                    Home
                </a>
            </li>
            <li>
                <a href="{{ route('Create-Form') }}" class="{{ Request::is('create') ? 'font-bold underline' : '' }} hover:text-gray-300">
                    News
                </a>
            </li>
            <li>
            ...
            <div class="ml-auto flex items-center space-x-4">
                ...
                @auth
                    <li class="relative Dropdown">
                        ...
                        <button
                            id="ButtonClick"
                            class="flex items-center space-x-2 px-4 py-2 text-sm font-medium text-gray-200 bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none">
                                {{ auth()->user()->name }}
